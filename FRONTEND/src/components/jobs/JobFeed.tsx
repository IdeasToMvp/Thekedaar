...
import type { FeedJob, FeedResponse } from "@/lib/jobs/types";
...
export function JobFeed() {
  ...
  return (
    <section id="jobs" className="overflow-x-hidden py-10 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="space-y-4">
          <div>
            <h2 className="text-xl font-bold tracking-tight text-foreground sm:text-3xl">Open jobs</h2>
        ...
        {loading ? (
          ...
          <p className="mt-6 rounded-2xl border border-dashed border-border bg-surface px-4 py-10 text-center text-sm text-muted sm:mt-10 sm:px-6 sm:py-12">
